class Blz < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/outfitter-dev/blz/releases/download/v1.5.5/blz-1.5.5-darwin-arm64.tar.gz"
      sha256 "ad0bd95b75e414877da81d199c110a6fbeaded284949d676e66911fb795d3410"
    end
    on_intel do
      url "https://github.com/outfitter-dev/blz/releases/download/v1.5.5/blz-1.5.5-darwin-x64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/outfitter-dev/blz/releases/download/v1.5.5/blz-1.5.5-linux-x64.tar.gz"
